                ...
                <div className="flex items-start space-x-4 mb-4">
                  ...
                  <div className="flex items-center space-x-3">
                    <div className="w-16 h-16 rounded-full border-2 border-orange-200 overflow-hidden shadow-lg">
                      <img
                        src="./images/CEO.png" // Update with your logo path
            ...
            <div className="flex flex-col md:flex-row justify-between items-center space-y-3 md:space-y-0">
              ...
              <div className="text-center md:text-left">
                <p className="text-gray-400 text-sm">
                  © {currentYear} <span className="text-orange-400 font-semibold">Anand Technology & Safety</span>. All rights reserved.
                </p>
              </div>
